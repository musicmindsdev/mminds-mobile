...
class ApiService extends ApiConstants with RetryFunc {
  ...
  //     throw InternetException(e.toString());
  //   } on DioException catch (error) {
  //     logger.e('DioException: ${error.response?.statusCode}');
  //     logger.e('DioException data: ${error.response?.data}');
  //     showToast(
  //       msg: UtilFunctions.capitalizeAllWord(
  //           error.response?.data['message'] ?? "Something went wrong"),
  //       isError: true,
  //     );
  //     throw error; // Rethrow the error to catch it in deleteUserProfile
  //   } on FormatException catch (error) {
  //     logger.e('FormatException: ${error.message}');
  //     showToast(
  //       msg: error.message.toString(),
